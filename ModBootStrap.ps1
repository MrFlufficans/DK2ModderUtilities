...
Write-Host "`n`n     What Preset would you Like?`n"
Write-Host "  Full      : The Whole Shabang, Normally for Complete Overhauls"
Write-Host "  Equipment : Purely for an Equipment Mod"
Write-Host "  Unit      : Unit Mod includes basic Equipment and Unit Setup"
Write-Host "  Blank     : Just like it says on the Tin, Nothing other than a Mod.xml"

$PresetChoice = Read-Host
